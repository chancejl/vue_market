...
});define("register/index.js",["common/wx/Step.js","biz_common/jquery.validate.js","wxverify/validateExtend.js","register/model.js","register/step3.js","register/step4.js","register/step5.js"],function(e){
"use strict";
function t(e){
return null==g[e]?(window.location.href="/cgi-bin/readtemplate?t=register/step1_tmpl&lang="+window.wx.data.lang,
!1):(r.setStep(e-1),$("#div_register").html(p(c[e],o.getData())),void g[e].init({
model:o
}));
}
function s(){
...
container:"#stepItems",
selected:wx.cgiData.step-1,
names:["1 基本信息","2 选择类型","3 信息登记","4 公众号信息"]
});
}
function i(){
o.setStep(wx.cgiData.step);
}
function n(){}
function a(){
s(),i(),n();
}
var r,p=(wx.T,template.render),l=e("common/wx/Step.js"),o=(e("biz_common/jquery.validate.js"),
e("wxverify/validateExtend.js"),e("register/model.js")),g=[null,null,null,e("register/step3.js"),e("register/step4.js"),e("register/step5.js")],c=["","tpl_step1","tpl_step2","tpl_step3","tpl_step4","tpl_step5"];
a();
});